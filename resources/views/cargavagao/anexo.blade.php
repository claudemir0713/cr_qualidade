...
@section('content')
    ...
    <hr>
    <form action="{{ route('cargavagao.upload') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            ...
            <table class="table table-condensed table-bordered">
                ...
                <tbody>
                    @foreach ($cargavagao_imagem as $item)
                        <tr>
                            <td>
                                <embed src="{{ asset('storage/cargaVagao/'.$extrusoras->lote.'/'.$item->anexo)  }}" type=""  style="width: 100%">
                            </td>
                            <td>
