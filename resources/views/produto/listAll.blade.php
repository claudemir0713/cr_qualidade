...
@section('content')
    <table class="table table-borderless table-advance table-condensed">
        <tr>
            <td width="80%">
                <h3>
                    <i class="fas fa-funnel-dollar"></i> Produto
                </h3>
            </td>
            ...
            <form method="get" action="{{ route('produto.listAll') }}">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        Produto:
                        <input type="text" class="form-control" name="produto" id="produto" value="{{ array_key_exists('produto',$dateForm) ? $dateForm['produto'] : '' }}">
                    </div>
                    <div class="form-group col-md-2">
                        Status:
        ...
        <tbody>
            @foreach ($produtos as $produto)
                <tr>
                    ...
                    <td align="center">{{ $produto->un }}  </td>
                    <td align="right">{{ number_format($produto->quebra,2,',','.')}}  </td>
                    <td align="right">{{ number_format($produto->custo,2,',','.') }}  </td>
                    <td align="center">
